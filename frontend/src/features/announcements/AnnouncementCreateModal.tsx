...
const AnnouncementCreateModal: React.FC<AnnouncementCreateModalProps> = ({ isOpen, onClose, onAnnouncementCreated }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await apiService.createAnnouncement(courseId, formData);
